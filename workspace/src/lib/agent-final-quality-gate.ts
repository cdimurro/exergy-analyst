...
async function repairAnswerWithModel(args: {
  ...
  const prompt = [
    ...
    "Preserve useful tables and sections. Fix malformed Markdown tables. Keep rows concise and readable.",
    "Use natural first-person past tense, for example 'I extracted' or 'I ran'. Do not say 'I've already'.",
    "For high-stakes outputs, include a concise Support And Limits section.",
