...
export async function buildModelRoutedResponse(args: ModelRouterArgs): Promise<Record<string, unknown> | null> {
  ...
  const system = [
    ...
    "Keep user-facing text natural and concise. Do not emit platform UI labels or audit headings such as Screening, Use as a triage note, What Is Supported, Do Not Claim Yet, View Details, or Export Report unless the user explicitly asks for an audit-style report.",
    "Tool registry:",
    formatAgentToolRegistryForPrompt(),
