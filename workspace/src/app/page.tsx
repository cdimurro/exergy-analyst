      ...
      <section className="relative min-h-[92vh] flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-20 pb-12">
          ...
          <div className="mt-10 space-y-2.5 max-w-3xl mx-auto">
            <ExamplePrompt
              text="Can you look at this battery claim, separate the useful evidence from the wishful thinking, and tell me what to ask next?"
              name="NMC 811 Cathode Evaluation" domain="battery_ecm"
              prompt="Review a new NMC 811 lithium-ion battery cathode claim with stated energy density, cycle life, rate capability, operating range, and cathode loading. Separate what the data can support from what still needs evidence. Identify the physical plausibility questions, likely failure modes, benchmark comparisons, and the next measurements that would make the assessment stronger."
            />
            <ExamplePrompt
              text="I have a solar module spec and a hot desert site. Help me understand what matters before I believe the headline rating."
              name="TOPCon Desert Performance" domain="pv_iv"
              prompt="Review a TOPCon bifacial solar module for a hot desert installation. Use the module specification and site conditions to identify the main performance drivers, likely derating factors, evidence gaps, and the assumptions that would matter most in a real project model."
            />
            <ExamplePrompt
              text="Here is a reactor concept. Help me find the physics questions, the safety margins, and the claims that should not be trusted yet."
              name="250 MWt PWR SMR Physics" domain="nuclear_fission"
              prompt="Review a pressurized water small reactor concept. Identify the physics and thermal-hydraulic questions that matter most, the parameters needed for a defensible screen, the margins that should be checked, and the claims that require independent engineering review."
            />
